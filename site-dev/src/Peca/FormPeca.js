...
import NomeMidia from '../components/Pecas/NomeMidia';
import RegiaoMidia from '../components/Pecas/RegiaoMidia';
import SistemaMidia from '../components/Pecas/SistemaMidia';
...
const FormPeca = ({ nome, idioma, regiao, sistema, erros, somentePratica, listaSistema, listaRegiao, onOpenSnackbar, onChange, onChangeSomentePratica, generalidades, apresentacao, nomeMidia, regiaoMidia, sistemaMidia }) => {
